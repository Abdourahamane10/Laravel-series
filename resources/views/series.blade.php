    ...
    <div>
        ...
        <ul class="utl">
            @foreach ($series as $serie)
                <li class="relative">
                    @if ($serie->media != "")
                    <a href="#"><img src="{{url('/storage/media/'.$serie->media.'.jpg')}}" alt="media" height="200" width="200"/></a><br>
                @else
                    <a href="#"><img src="{{url('/storage/media/mediaDefault.png')}}" alt="media" height="200" width="200"/></a><br>
                @endif
